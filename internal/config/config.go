...
type Config struct {
	...
	Mode                  *string  `json:"mode,omitempty" yaml:"mode,omitempty" jsonschema:"title=Version Mode,description=Version format mode: 'semver' (default) outputs standard semantic versioning or 'pep440' outputs Python PEP 440 compatible versions,enum=semver,enum=pep440"`
